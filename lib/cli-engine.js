 ...
 * @param {Object} configHelper The configuration options for nplint.
 ...
 * @private
 */
function processText(text, configHelper, filePath, callback) {
...
CLIEngine.prototype = {
   ...
   */
  executeOnFile: function(filePath, callback) {
   ...
   */
  executeOnText: function(text, filePath, callback) {

    var options = this.options,
      configHelper = new Config(options);

    processText(text, configHelper, filePath, callback);
  },
